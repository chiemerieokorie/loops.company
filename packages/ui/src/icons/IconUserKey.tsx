...
export const IconUserKey: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase
		{...props}
		ariaLabel="user-key, people, person, member, passkeys, access"
	>
		{variant === "filled" ? (
			<>
				<path
			...
			<>
				...
				<path
					...
					strokeWidth="1.5"
				/>
				<circle cx="19.0992" cy="15.4" fill="currentColor" r="0.9" />
				<path
					d="M18.8496 12.5498C20.5617 12.5498 21.9502 13.9383 21.9502 15.6504C21.95 17.3623 20.5616 18.75 18.8496 18.75C18.5179 18.75 18.199 18.6961 17.8994 18.5996L15.75 20.75H13.75V18.75L15.8994 16.5996C15.8032 16.3004 15.75 15.9816 15.75 15.6504C15.75 13.9384 17.1377 12.55 18.8496 12.5498Z"
					stroke="currentColor"
					strokeLinejoin="round"
					strokeWidth="1.5"
				/>
