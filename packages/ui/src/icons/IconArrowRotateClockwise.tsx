...
export const IconArrowRotateClockwise: FC<CentralIconProps> = ({
	...
	<CentralIconBase {...props} ariaLabel="arrow-rotate-clockwise, rotate-right">
		{variant === "filled" ? (
			...
			<>
				<path
					d="M18.5 7.00891C16.6791 4.95438 14.7962 3.75 11.979 3.75C7.42266 3.75 3.729 7.44365 3.729 12C3.729 16.5563 7.42266 20.25 11.979 20.25C15.5711 20.25 18.627 17.9543 19.7596 14.75"
					stroke="currentColor"
					strokeLinecap="round"
