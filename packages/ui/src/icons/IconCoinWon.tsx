	...
	<CentralIconBase {...props} ariaLabel="coin-won, currency, money">
		{variant === "filled" ? (
			...
			<>
				...
				/>
				<path
					d="M7.75 8.5L9.875 16L12 8.5L14.125 16L16.25 8.5"
					stroke="currentColor"
					strokeLinecap="round"
