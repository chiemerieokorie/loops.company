...
export const IconCloudUpload: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase {...props} ariaLabel="cloud-upload">
		{variant === "filled" ? (
			<>
				<path
			...
			<>
				<path
					d="M12 19.25V11.75M12 11.75L14.5 14.25M12 11.75L9.5 14.25"
					stroke="currentColor"
					strokeLinecap="round"
