...
export const IconDotGrid1x3Vertical: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase
	...
	>
		{variant === "filled" ? (
			<>
				<path
					d="M12 2C11.0335 2 10.25 2.7835 10.25 3.75C10.25 4.7165 11.0335 5.5 12 5.5C12.9665 5.5 13.75 4.7165 13.75 3.75C13.75 2.7835 12.9665 2 12 2Z"
					fill="currentColor"
				/>
				<path
				...
				/>
				<path
					d="M12 18.5C11.0335 18.5 10.25 19.2835 10.25 20.25C10.25 21.2165 11.0335 22 12 22C12.9665 22 13.75 21.2165 13.75 20.25C13.75 19.2835 12.9665 18.5 12 18.5Z"
					fill="currentColor"
				/>
			</>
		) : (
