...
export const IconMountainBike: FC<CentralIconProps> = ({
	...
	<CentralIconBase {...props} ariaLabel="mountain-bike">
		{variant === "filled" ? (
			...
			<>
				<path
					d="M19 15L16.6314 6.90731C16.2572 5.62866 15.0823 4.75 13.75 4.75V4.75M6.75 6.75H9.75M10.9643 11.575L7.75 7M16.75 8.75L5 15"
					stroke="currentColor"
					strokeLinecap="round"
