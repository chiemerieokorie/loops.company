...
export const IconPageEditText: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase {...props} ariaLabel="page-edit-text, document, file">
		{variant === "filled" ? (
			<>
				<path
					clipRule="evenodd"
					d="M4 5.75C4 3.67893 5.67893 2 7.75 2H16.25C18.3211 2 20 3.67893 20 5.75V12.6674C18.6206 12.1667 17.0152 12.4694 15.909 13.5756L12.159 17.3256C11.7371 17.7476 11.5 18.3199 11.5 18.9166V21.2499C11.5 21.5129 11.5451 21.7654 11.6281 22H7.75C5.67893 22 4 20.3211 4 18.25V5.75ZM8 6.75C8 6.33579 8.33579 6 8.75 6H15.25C15.6642 6 16 6.33579 16 6.75C16 7.16421 15.6642 7.5 15.25 7.5H8.75C8.33579 7.5 8 7.16421 8 6.75ZM8.75 10C8.33579 10 8 10.3358 8 10.75C8 11.1642 8.33579 11.5 8.75 11.5H11.25C11.6642 11.5 12 11.1642 12 10.75C12 10.3358 11.6642 10 11.25 10H8.75Z"
					fill="currentColor"
					fillRule="evenodd"
				/>
				<path
