...
export const IconSleep: FC<CentralIconProps> = ({
	...
	<CentralIconBase {...props} ariaLabel="sleep, snooze, zzz">
		{variant === "filled" ? (
			...
			<>
				<path
					d="M3.75 8.75H8.25L3.75 15.25H8.25"
					stroke="currentColor"
					strokeLinecap="round"
				...
				/>
				<path
					d="M11.75 2.75H15.75L11.75 8.25H15.75"
					stroke="currentColor"
					strokeLinecap="round"
					strokeLinejoin="round"
					strokeWidth="1.5"
				/>
				<path
					d="M12.75 12.75H19.25L12.75 21.25H19.25"
					stroke="currentColor"
					strokeLinecap="round"
					strokeLinejoin="round"
					strokeWidth="1.5"
