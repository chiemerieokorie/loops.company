...
export const IconDateCustom: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase {...props} ariaLabel="date-custom">
		{variant === "filled" ? (
			<>
				<path
			...
			<>
				...
				/>
				<path
					d="M12.75 5.5C12.75 5.91421 12.4142 6.25 12 6.25C11.5858 6.25 11.25 5.91421 11.25 5.5C11.25 5.08579 11.5858 4.75 12 4.75C12.4142 4.75 12.75 5.08579 12.75 5.5Z"
					fill="currentColor"
					stroke="currentColor"
					strokeWidth="1.5"
				/>
