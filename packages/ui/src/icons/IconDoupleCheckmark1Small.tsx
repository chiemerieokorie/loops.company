...
export const IconDoupleCheckmark1Small: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase {...props} ariaLabel="douple-checkmark-1-small">
		{variant === "filled" ? (
			<>
				<path
			...
			<>
				<path
					d="M5.75 13.0625L8.9375 16.25L14.25 7.75"
					stroke="currentColor"
					strokeLinecap="round"
