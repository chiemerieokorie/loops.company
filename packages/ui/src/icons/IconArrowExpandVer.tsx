...
export const IconArrowExpandVer: FC<CentralIconProps> = ({
	...
	<CentralIconBase {...props} ariaLabel="arrow-expand-ver">
		{variant === "filled" ? (
			...
			<>
				<path
					d="M7.75 7L12 2.75L16.25 7M7.75 17L12 21.25L16.25 17M12 20V4"
					stroke="currentColor"
					strokeLinecap="round"
