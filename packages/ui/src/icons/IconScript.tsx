...
export const IconScript: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase
		{...props}
		ariaLabel="script, paper, page, contract, file, document, skills"
	>
		{variant === "filled" ? (
			<>
				<path
					clipRule="evenodd"
					d="M19.25 3C20.7535 3 22 4.24646 22 5.75V7.25015C22 8.76901 20.7687 10 19.25 10H18V18.2496C18 19.7684 16.7688 20.9996 15.25 20.9996L5.7829 21C5.04485 21 4.33701 20.7069 3.81503 20.1851C3.29283 19.6631 3 18.9551 3 18.2175V17.7501C3 16.2314 4.23116 15 5.75 15H6V5.7464C6 5.01757 6.28957 4.31843 6.80645 3.80312C7.32262 3.28775 8.02211 3 8.75035 3H19.25ZM18 5.75V8.5H19.25C19.9404 8.5 20.5 7.94043 20.5 7.25015V5.75C20.5 5.07489 19.9251 4.5 19.25 4.5C18.9185 4.50007 18.6003 4.63183 18.3662 4.86609C18.1317 5.10061 18 5.41854 18 5.75ZM12.5 17.4798C12.4987 16.9385 12.0594 16.5 11.5178 16.5H5.75C5.0597 16.5 4.5 17.0597 4.5 17.7501V18.2175C4.5 18.5576 4.63507 18.8839 4.8755 19.1243C5.11615 19.3648 5.44252 19.5 5.7829 19.5H12.8C12.6082 19.1249 12.5 18.6999 12.5 18.2496V17.4798ZM10 7.75C10 7.33579 10.3358 7 10.75 7H12.75C13.1642 7 13.5 7.33579 13.5 7.75C13.5 8.16421 13.1642 8.5 12.75 8.5H10.75C10.3358 8.5 10 8.16421 10 7.75ZM10.75 10C10.3358 10 10 10.3358 10 10.75C10 11.1642 10.3358 11.5 10.75 11.5H11.75C12.1642 11.5 12.5 11.1642 12.5 10.75C12.5 10.3358 12.1642 10 11.75 10H10.75Z"
					fill="currentColor"
					fillRule="evenodd"
				/>
			</>
