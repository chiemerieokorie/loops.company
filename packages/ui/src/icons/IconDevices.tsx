...
export const IconDevices: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase
	...
	>
		{variant === "filled" ? (
			...
			<>
				<path
					d="M14.25 11.75C14.25 10.0931 15.5931 8.75 17.25 8.75H19.25C20.9069 8.75 22.25 10.0931 22.25 11.75V18.25C22.25 19.9069 20.9069 21.25 19.25 21.25H17.25C15.5931 21.25 14.25 19.9069 14.25 18.25V11.75Z"
					stroke="currentColor"
					strokeLinecap="round"
				...
				/>
				<path
					d="M20.25 8.75V6.75C20.25 5.09315 18.9069 3.75 17.25 3.75H6.75C5.09315 3.75 3.75 5.09315 3.75 6.75V14.75C3.75 15.8546 2.85457 16.75 1.75 16.75V17.25C1.75 18.9069 3.09315 20.25 4.75 20.25H14.75"
					stroke="currentColor"
					strokeLinecap="round"
					strokeLinejoin="round"
					strokeWidth="1.5"
