...
export const IconArrowSplitUp: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase
	...
	>
		{variant === "filled" ? (
			...
			<>
				<path
					d="M3.75 9.25V3.75M3.75 3.75H9.25M3.75 3.75L12 12M14.75 3.75H20.25M20.25 3.75V9.25M20.25 3.75L12 12M12 12V20.25"
					stroke="currentColor"
					strokeLinecap="round"
