...
export const IconDoupleCheckmark1: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase {...props} ariaLabel="douple-checkmark-1">
		{variant === "filled" ? (
			<>
				<path
			...
			<>
				<path
					d="M2.75 12.7768L7.92857 19.25L17.25 4.75"
					stroke="currentColor"
					strokeLinecap="round"
