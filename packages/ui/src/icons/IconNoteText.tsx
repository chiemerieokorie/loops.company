...
export const IconNoteText: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase {...props} ariaLabel="note-text">
		{variant === "filled" ? (
			<>
				<path
					clipRule="evenodd"
					d="M3 6.75C3 4.67893 4.67893 3 6.75 3H17.25C19.3211 3 21 4.67893 21 6.75V14.5H18.25C16.1789 14.5 14.5 16.1789 14.5 18.25V21H6.75C4.67893 21 3 19.3211 3 17.25V6.75ZM8 8.75C8 8.33579 8.33579 8 8.75 8H15.25C15.6642 8 16 8.33579 16 8.75C16 9.16421 15.6642 9.5 15.25 9.5H8.75C8.33579 9.5 8 9.16421 8 8.75ZM8.75 12C8.33579 12 8 12.3358 8 12.75C8 13.1642 8.33579 13.5 8.75 13.5H11.25C11.6642 13.5 12 13.1642 12 12.75C12 12.3358 11.6642 12 11.25 12H8.75Z"
					fill="currentColor"
					fillRule="evenodd"
				/>
				<path
