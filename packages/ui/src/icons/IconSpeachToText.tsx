...
export const IconSpeachToText: FC<CentralIconProps> = ({
	...
	<CentralIconBase {...props} ariaLabel="speach-to-text, voice-to-text">
		{variant === "filled" ? (
			...
			<>
				<path
					d="M13.25 13.75V11.75H17.5M21.75 13.75V11.75H17.5M17.5 11.75V20.25M17.5 20.25H15.75M17.5 20.25H19.25"
					stroke="currentColor"
					strokeLinecap="round"
