...
export const IconBatteryMedium: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase {...props} ariaLabel="battery-medium, power">
		{variant === "filled" ? (
			<>
				<path
					clipRule="evenodd"
					d="M4.75 5C2.67893 5 1 6.67893 1 8.75V15.25C1 17.3211 2.67893 19 4.75 19H16.25C18.0642 19 19.5775 17.7117 19.925 16H20.75C21.9926 16 23 14.9926 23 13.75V10.25C23 9.00736 21.9926 8 20.75 8H19.925C19.5775 6.28832 18.0642 5 16.25 5H4.75ZM20 9.5V14.5H20.75C21.1642 14.5 21.5 14.1642 21.5 13.75V10.25C21.5 9.83579 21.1642 9.5 20.75 9.5H20ZM6 9C6.41421 9 6.75 9.33579 6.75 9.75V14.25C6.75 14.6642 6.41421 15 6 15C5.58579 15 5.25 14.6642 5.25 14.25V9.75C5.25 9.33579 5.58579 9 6 9ZM11.25 9.75C11.25 9.33579 10.9142 9 10.5 9C10.0858 9 9.75 9.33579 9.75 9.75V14.25C9.75 14.6642 10.0858 15 10.5 15C10.9142 15 11.25 14.6642 11.25 14.25V9.75Z"
					fill="currentColor"
					fillRule="evenodd"
				/>
			</>
