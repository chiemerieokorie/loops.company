...
export const IconGamepadControlsRound: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase {...props} ariaLabel="gamepad-controls-round, joystick">
		{variant === "filled" ? (
			<>
				<path
				...
				/>
				<path
					d="M22 12C22 9.92893 20.3211 8.25 18.25 8.25C16.1789 8.25 14.5 9.92893 14.5 12C14.5 14.0711 16.1789 15.75 18.25 15.75C20.3211 15.75 22 14.0711 22 12Z"
					fill="currentColor"
				/>
				<path
