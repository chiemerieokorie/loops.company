...
export const IconGamepadControlsRoundUp: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase {...props} ariaLabel="gamepad-controls-round-up">
		{variant === "filled" ? (
			<>
				<path
					clipRule="evenodd"
					d="M12 2C14.0711 2 15.75 3.67893 15.75 5.75C15.75 7.82107 14.0711 9.5 12 9.5C9.92893 9.5 8.25 7.82107 8.25 5.75C8.25 3.67893 9.92893 2 12 2ZM14.25 5.75C14.25 4.50736 13.2426 3.5 12 3.5C10.7574 3.5 9.75 4.50736 9.75 5.75C9.75 6.99264 10.7574 8 12 8C13.2426 8 14.25 6.99264 14.25 5.75Z"
					fill="currentColor"
					fillRule="evenodd"
				/>
				<path
			...
			<>
				...
				/>
				<path
					d="M5.75 9C7.40685 9 8.75 10.3431 8.75 12C8.75 13.6569 7.40685 15 5.75 15C4.09315 15 2.75 13.6569 2.75 12C2.75 10.3431 4.09315 9 5.75 9Z"
					stroke="currentColor"
					strokeLinecap="square"
					strokeWidth="1.5"
				/>
				<path
					d="M18.25 9C19.9069 9 21.25 10.3431 21.25 12C21.25 13.6569 19.9069 15 18.25 15C16.5931 15 15.25 13.6569 15.25 12C15.25 10.3431 16.5931 9 18.25 9Z"
					stroke="currentColor"
					strokeLinecap="square"
					strokeWidth="1.5"
				/>
