...
export const IconFullscreen2: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase {...props} ariaLabel="fullscreen-2">
		{variant === "filled" ? (
			<>
				<path
					d="M5.75 4C3.67893 4 2 5.67893 2 7.75V16.25C2 18.3211 3.67893 20 5.75 20H18.25C20.3211 20 22 18.3211 22 16.25V7.75C22 5.67893 20.3211 4 18.25 4H5.75Z"
					fill="currentColor"
				/>
			</>
		) : (
