...
export const IconConcise: FC<CentralIconProps> = ({
	...
	<CentralIconBase {...props} ariaLabel="concise, text-shorten, squeeze">
		{variant === "filled" ? (
			...
			<>
				<path
					d="M3.75 10.25H20.25M20.25 13.75H3.75"
					stroke="currentColor"
					strokeLinecap="round"
