...
export const IconIncrease: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase
	...
	>
		{variant === "filled" ? (
			<>
				...
				/>
				<path
					d="M16.0058 4.66797C16.0738 4.25941 16.4605 3.98287 16.8691 4.05078C18.445 4.31298 19.6872 5.55579 19.9492 7.13184C20.017 7.54039 19.7405 7.9262 19.332 7.99414C18.9236 8.06186 18.5377 7.78628 18.4697 7.37793C18.3129 6.43459 17.5663 5.68824 16.623 5.53125C16.2144 5.46328 15.9379 5.07653 16.0058 4.66797Z"
					fill="currentColor"
				/>
				<path
			...
			<>
				...
				/>
				<path
					d="M16.7461 4.79102C18.0058 5.00057 19.0001 5.99497 19.2094 7.2547"
					stroke="currentColor"
					strokeLinecap="round"
					strokeLinejoin="round"
					strokeWidth="1.5"
