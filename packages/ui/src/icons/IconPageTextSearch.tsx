...
export const IconPageTextSearch: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase {...props} ariaLabel="page-text-search">
		{variant === "filled" ? (
			<>
				<path
					clipRule="evenodd"
					d="M4 5.75C4 3.67893 5.67893 2 7.75 2H16.25C18.3211 2 20 3.67893 20 5.75V12.626C19.0149 11.9174 17.8062 11.5 16.5 11.5C13.1863 11.5 10.5 14.1863 10.5 17.5C10.5 19.292 11.2856 20.9006 12.5313 22H7.75C5.67893 22 4 20.3211 4 18.25V5.75ZM7 5.75C7 5.33579 7.33579 5 7.75 5H14.25C14.6642 5 15 5.33579 15 5.75C15 6.16421 14.6642 6.5 14.25 6.5H7.75C7.33579 6.5 7 6.16421 7 5.75ZM7 9.75C7 9.33579 7.33579 9 7.75 9H11.25C11.6642 9 12 9.33579 12 9.75C12 10.1642 11.6642 10.5 11.25 10.5H7.75C7.33579 10.5 7 10.1642 7 9.75Z"
					fill="currentColor"
					fillRule="evenodd"
				/>
				<path
