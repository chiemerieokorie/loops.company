...
export const IconCurrencyPounds: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase {...props} ariaLabel="currency-pounds, money">
		{variant === "filled" ? (
			...
			<>
				<path
					d="M5.75 20.25C10.688 20.25 8.8855 11.313 8.8855 8.39062C8.8855 5.82768 10.9912 3.75 13.5888 3.75C15.2194 3.75 16.6563 4.56883 17.5 5.8125"
					stroke="currentColor"
					strokeLinecap="round"
