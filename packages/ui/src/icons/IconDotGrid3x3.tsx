...
export const IconDotGrid3x3: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase {...props} ariaLabel="dot-grid-3x3, menu, drag, grab">
		{variant === "filled" ? (
			<>
				<path
					d="M4.75 3C3.7835 3 3 3.7835 3 4.75C3 5.7165 3.7835 6.5 4.75 6.5C5.7165 6.5 6.5 5.7165 6.5 4.75C6.5 3.7835 5.7165 3 4.75 3Z"
					fill="currentColor"
				/>
				<path
					d="M12 3C11.0335 3 10.25 3.7835 10.25 4.75C10.25 5.7165 11.0335 6.5 12 6.5C12.9665 6.5 13.75 5.7165 13.75 4.75C13.75 3.7835 12.9665 3 12 3Z"
					fill="currentColor"
				/>
				<path
					d="M19.25 3C18.2835 3 17.5 3.7835 17.5 4.75C17.5 5.7165 18.2835 6.5 19.25 6.5C20.2165 6.5 21 5.7165 21 4.75C21 3.7835 20.2165 3 19.25 3Z"
					fill="currentColor"
				/>
				<path
					d="M4.75 10.25C3.7835 10.25 3 11.0335 3 12C3 12.9665 3.7835 13.75 4.75 13.75C5.7165 13.75 6.5 12.9665 6.5 12C6.5 11.0335 5.7165 10.25 4.75 10.25Z"
					fill="currentColor"
				/>
				<path
				...
				/>
				<path
					d="M19.25 10.25C18.2835 10.25 17.5 11.0335 17.5 12C17.5 12.9665 18.2835 13.75 19.25 13.75C20.2165 13.75 21 12.9665 21 12C21 11.0335 20.2165 10.25 19.25 10.25Z"
					fill="currentColor"
				/>
				<path
					d="M4.75 17.5C3.7835 17.5 3 18.2835 3 19.25C3 20.2165 3.7835 21 4.75 21C5.7165 21 6.5 20.2165 6.5 19.25C6.5 18.2835 5.7165 17.5 4.75 17.5Z"
					fill="currentColor"
				/>
				<path
					d="M12 17.5C11.0335 17.5 10.25 18.2835 10.25 19.25C10.25 20.2165 11.0335 21 12 21C12.9665 21 13.75 20.2165 13.75 19.25C13.75 18.2835 12.9665 17.5 12 17.5Z"
					fill="currentColor"
				/>
				<path
					d="M19.25 17.5C18.2835 17.5 17.5 18.2835 17.5 19.25C17.5 20.2165 18.2835 21 19.25 21C20.2165 21 21 20.2165 21 19.25C21 18.2835 20.2165 17.5 19.25 17.5Z"
					fill="currentColor"
				/>
			</>
		) : (
