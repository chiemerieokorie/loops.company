...
export const IconControllerButtonX: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase
		{...props}
		ariaLabel="controller-button-x, dismiss, close, cancel, delete, remove"
	>
		{variant === "filled" ? (
			<>
				<path
			...
			<>
				...
				/>
				<path
					d="M8.625 8.625L15.375 15.375M15.375 8.625L8.625 15.375"
					stroke="currentColor"
					strokeLinecap="round"
					strokeLinejoin="round"
					strokeWidth="1.5"
