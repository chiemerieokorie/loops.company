...
export const IconDoupleCheck: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase {...props} ariaLabel="douple-check">
		{variant === "filled" ? (
			<>
				<path
			...
			<>
				<path
					d="M1.75 14.7187L7.51961 19.25L18.25 4.75"
					stroke="currentColor"
					strokeLinecap="round"
