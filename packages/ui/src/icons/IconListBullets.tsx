...
export const IconListBullets: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
		...
		{variant === "filled" ? (
			...
			<>
				<path
					...
					strokeWidth="1.5"
				/>
				<circle cx="4.2" cy="5.9998" fill="currentColor" r="1.2" />
				<path
					d="M8.75 12L20.25 12"
					stroke="currentColor"
					strokeLinecap="round"
					strokeWidth="1.5"
				/>
				<circle cx="4.2" cy="11.9998" fill="currentColor" r="1.2" />
				<path
					d="M8.75 18L20.25 18"
					stroke="currentColor"
					strokeLinecap="round"
					strokeWidth="1.5"
				/>
				<circle cx="4.2" cy="17.9998" fill="currentColor" r="1.2" />
			</>
		)}
	</CentralIconBase>
);
