...
export const IconSquareDotedBehindSquare: FC<CentralIconProps> = ({
	variant = "outlined",
	...props
}) => (
	<CentralIconBase
		{...props}
		ariaLabel="square-doted-behind-square, copy, layers, pages"
	>
		{variant === "filled" ? (
			<>
				<path
				...
				/>
				<path
					d="M9.5 8C9.5 7.58579 9.16421 7.25 8.75 7.25C8.33579 7.25 8 7.58579 8 8H5C3.34315 8 2 9.34315 2 11V19C2 20.6569 3.34315 22 5 22H13C14.6569 22 16 20.6569 16 19V16C16.4142 16 16.75 15.6642 16.75 15.25C16.75 14.8358 16.4142 14.5 16 14.5V11C16 9.34315 14.6569 8 13 8H9.5Z"
					fill="currentColor"
				/>
				<path
			...
			<>
				<path
					d="M8.75 8V8.75M14 2.75H16M21.25 8V10M16 15.25H15.25M19 2.75C20.2426 2.75 21.25 3.75736 21.25 5M21.25 13C21.25 14.2426 20.2426 15.25 19 15.25M8.75 5C8.75 3.75736 9.75736 2.75 11 2.75M13 8.75H5C3.75736 8.75 2.75 9.75736 2.75 11V19C2.75 20.2426 3.75736 21.25 5 21.25H13C14.2426 21.25 15.25 20.2426 15.25 19V11C15.25 9.75736 14.2426 8.75 13 8.75Z"
					stroke="currentColor"
					strokeLinecap="round"
