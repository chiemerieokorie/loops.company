			...
			<div className="fixed inset-x-0 top-0 z-50 in-data-scrolled:border-b in-data-scrolled:bg-background/50 in-data-scrolled:backdrop-blur">
				<div className="mx-auto max-w-6xl px-6 lg:px-12">
					<div className="relative flex flex-wrap items-center justify-between lg:py-5">
						...
						{/* Nav is absolutely centered over the full header width */}
						<div className="absolute inset-0 m-auto size-fit">
							<nav
								aria-label="Main"
								className="group/navigation-menu relative flex max-w-max flex-1 items-center justify-center **:data-[slot=navigation-menu-content]:top-10 max-lg:hidden"
