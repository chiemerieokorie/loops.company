export interface ContactSalesMinimalProps {
	address?: string;
	badge?: string;
	description?: string;
	email?: string;
...
export function ContactSalesMinimal({
	badge = "Sales",
	...
	return (
		<section className="bg-background py-24">
			<div className="@container mx-auto max-w-5xl px-6">
				...
				<span className="my-12 block h-px bg-[linear-gradient(90deg,var(--color-foreground)_1px,transparent_1px)] bg-bottom bg-size-[6px_1px] bg-repeat-x opacity-30 dark:opacity-15" />
				<div className="grid max-lg:gap-20 md:grid-cols-2">
					<form
						className="relative max-w-sm space-y-6 **:data-[slot=label]:block"
						onSubmit={onSubmit}
					>
