export interface ContactGridFormProps {
...
export function ContactGridForm({
			...
			<div className="@container mx-auto max-w-5xl px-2">
				<div className="mx-auto max-w-4xl">
					...
					<div className="mx-auto mt-12 grid max-w-2xl @lg:grid-cols-2 gap-1 rounded-2xl border p-1">
						<div
							className="flex flex-col space-y-2.5 rounded-xl bg-card p-6 text-card-foreground shadow shadow-black/6.5 ring-1 ring-border md:p-12"
							data-slot="card"
						>
						...
						<div
							className="col-span-full flex flex-col rounded-xl bg-card p-6 text-card-foreground shadow shadow-black/6.5 ring-1 ring-border md:p-12"
							data-slot="card"
						>
