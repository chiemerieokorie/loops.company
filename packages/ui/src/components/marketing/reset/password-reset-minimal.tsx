export interface PasswordResetMinimalProps {
	cookiesHref?: string;
	logoHref?: string;
	privacyHref?: string;
	signInHref?: string;
...
export function PasswordResetMinimal({
	logoHref = "#",
	signInHref = "#",
	privacyHref = "#",
	termsHref = "#",
	cookiesHref = "#",
}: PasswordResetMinimalProps) {
	return (
				...
				<div className="m-auto max-w-xs text-center">
					...
					<div className="space-y-5">
						<form action="" className="space-y-5">
							<div>
								<label
									className="sr-only select-none font-medium text-sm leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-50 group-data-[disabled=true]:pointer-events-none group-data-[disabled=true]:opacity-50"
									data-slot="label"
									htmlFor="email"
								>
									Email
