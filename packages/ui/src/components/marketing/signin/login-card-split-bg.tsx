export interface LoginCardSplitBgProps {
	cookiesHref?: string;
	heading?: string;
	privacyHref?: string;
	signUpHref?: string;
...
export function LoginCardSplitBg({
	heading = "Sign In to Astor",
	subheading = "Welcome back! Sign in to continue",
	signUpHref = "#",
	privacyHref = "#",
	termsHref = "#",
	cookiesHref = "#",
}: LoginCardSplitBgProps) {
	return (
						...
						>
							...
							>
								<path
									...
									fill="url(#paint_logo_card_split)"
									fillRule="evenodd"
								/>
								<defs>
									<linearGradient
										gradientUnits="userSpaceOnUse"
										id="paint_logo_card_split"
										x1="90"
										x2="90"
										y1="0"
										y2="220"
