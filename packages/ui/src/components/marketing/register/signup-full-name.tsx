...
// Block011: Centered form with separate first+last name fields, email+password, reCAPTCHA notice in footer

export function SignupFullName() {
	return (
		<main className="bg-background">
			<div className="grid min-h-dvh grid-rows-[1fr_auto] gap-6 p-6">
				<div className="m-auto w-full max-w-72 self-center text-center">
					...
					<h1 className="mt-6 mb-10 font-semibold text-xl">
						Sign up for Astor
					</h1>
