...
// Block009: Stacked page layout (logo top-left), magic link primary action, optional password, 2-col OAuth below

export function SignupMagicLink() {
	return (
