...
// Block006: Centered card with dark squircle icon, Figma+Linear OAuth, name+email+password, terms checkbox, arrow button

export function SignupCardIcon() {
	return (
		<main className="@container relative min-h-dvh bg-background">
			<div className="relative flex min-h-dvh flex-col items-center justify-center p-6">
				<div
					className="w-full max-w-md rounded-2xl bg-card @sm:p-8 @sm:pt-6 text-card-foreground shadow shadow-black/4 ring-1 ring-border"
					data-slot="card"
				>
					{/* Card header */}
					<div
