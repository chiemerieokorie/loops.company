...
export interface FooterWithStatusProps {
...
export function FooterWithStatus({
	companyName = "Astor",
	...
	statusOk = true,
}: FooterWithStatusProps) {
	return (
		<footer className="bg-background py-8 sm:py-20" role="contentinfo">
